            ...
            return function (ctx) {
                ...
                var suggestion_help = Options_Applicative_Help_Core.suggestionsHelp((function () {
                    if (msg instanceof Options_Applicative_Types.UnexpectedError) {
                        ...
                        var prose = (function () {
                            var $81 = Data_Array.length(good) < 2;
                            if ($81) {
                ...
                var error_help = Options_Applicative_Help_Core.errorHelp((function () {
                    ...
                    if (msg instanceof Options_Applicative_Types.UnexpectedError) {
                        var msg$prime = (function () {
                            var $105 = Options_Applicative_Internal_Utils.startsWith("-")(msg.value0);
                            if ($105) {
...
var exitWith = function (c) {
    return Node_Process["exit$prime"](fromEnum(c));
};
var exitSuccess = /* #__PURE__ */ (function () {
    return Node_Process["exit$prime"](fromEnum(ExitCodes.Success.value));
})();
var handleParseResult = function (v) {
    ...
    if (v instanceof Options_Applicative_Types.Failure) {
        return function __do() {
            ...
            $$void(Node_Stream.writeString(stream)(Node_Encoding.UTF8.value)(v1.value0 + "\x0a"))();
    ...
    if (v instanceof Options_Applicative_Types.CompletionInvoked) {
        return function __do() {
            ...
            $$void(Node_Stream.writeString(Node_Process.stdout)(Node_Encoding.UTF8.value)(msg))();
            return exitSuccess();
        };
    };

        ...
        return {
            tabulate: function (f) {
                ...
                return function (v) {
                    ...
                    throw new Error("Failed pattern match at Data.Function.Memoize (line 95, column 7 - line 97, column 23): " + [ v.constructor.name ]);
                };
            }
        };
    };
    ...
    return {
        tabulate: function (f) {
            ...
            return function (v) {
                ...
                throw new Error("Failed pattern match at Data.Function.Memoize (line 85, column 7 - line 87, column 22): " + [ v.constructor.name ]);
            };
        }
    };
};
        ...
        return {
            tabulate: function (f) {
                ...
                return function (v) {
                    ...
                    throw new Error("Failed pattern match at Data.Function.Memoize (line 105, column 7 - line 107, column 21): " + [ v.constructor.name ]);
                };
            }
        };
    };
    ...
    return {
        tabulate: function (f) {
            var toList = function (v) {
                ...
                throw new Error("Failed pattern match at Data.Function.Memoize (line 134, column 5 - line 134, column 25): " + [ v.constructor.name ]);
            };
            var fromList = function (v) {
                ...
                throw new Error("Failed pattern match at Data.Function.Memoize (line 137, column 5 - line 137, column 27): " + [ v.constructor.name ]);
            };
